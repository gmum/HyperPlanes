# TODO - new version of NeRFShapeNet dataset for generalization
...
class NeRFShapeNetDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        item = {
            "images": np.array(sample["images"]).astype(np.float32),
            "cam_poses": np.array(sample["cam_poses"]).astype(np.float32),
        }
        return item
